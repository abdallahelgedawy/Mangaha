    ...
    */
    func toastViewForMessage(_ message: String?, title: String?, image: UIImage?, style: ToastStyle) throws -> UIView {
        ...
        if let image = image {
            ...
            imageView?.frame = CGRect(x: style.horizontalPadding, y: style.verticalPadding, width: style.imageSize.width, height: style.imageSize.height/2)
        }
...
public struct ToastStyle {
    ...
    */
    public var verticalPadding: CGFloat = 5.0
